...
function AdvertisingCard({ subtitle, title }: AdvertisingCardProps) {
  return (
    <aside aria-label={title} className="mx-auto w-full max-w-xl py-2 sm:py-4">
      <Card className="overflow-hidden border-indigo-200/80 bg-indigo-50/60 text-center transition-[border-color,box-shadow,transform] duration-200 hover:-translate-y-0.5 hover:border-indigo-300 hover:shadow-[0_12px_24px_-20px_rgb(15_23_42_/_0.32)] dark:border-indigo-950/80">
        <CardHeader className="items-center space-y-3 p-4 sm:p-5">
