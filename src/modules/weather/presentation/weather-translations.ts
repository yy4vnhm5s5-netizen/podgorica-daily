...
const weatherTranslations: Record<Locale, WeatherTranslations> = {
  en: {
    ...
    emptyDescription: "Data is currently unavailable.",
    emptyTitle: "No weather data",
    errorDescription: "Data is currently unavailable.",
  ...
  me: {
    ...
    emptyDescription: "Podaci trenutno nijesu dostupni.",
    emptyTitle: "Nema podataka o vremenu",
    errorDescription: "Podaci trenutno nijesu dostupni.",
