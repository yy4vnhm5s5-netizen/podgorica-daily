...
const eventTranslations = {
  en: {
    ...
    homepageSupportingText: "Current events in the city.",
    homepageUnavailable: "Data is currently unavailable.",
    loading: "Loading events",
    location: "Location",
    noEvents: "No events are available",
    noEventsDescription: "We have no listings from the official sources right now.",
  ...
  me: {
    ...
    homepageSupportingText: "Aktuelna dešavanja u gradu",
    homepageUnavailable: "Podaci trenutno nijesu dostupni.",
    loading: "Učitavanje događaja",
    location: "Mjesto",
    noEvents: "Nema dostupnih događaja",
    noEventsDescription: "Trenutno nemamo dostupne najave događaja iz zvaničnih izvora.",
