...
| ViK Ulcinj, every two hours                                    | `50 */2 * * *`            | `/api/internal/vik-ulcinj/refresh`        | `INTERNAL_REFRESH_TOKEN`           |
